    ...
    <section id="resume" className="scroll-mt-14 py-12 md:py-24">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <p className="text-sm leading-relaxed text-muted mb-16">
          会津高校在学中にはクイズ研究部を立ち上げ、高校生クイズ全国大会に出場。
          筑波大学・大学院では VR / Haptics を研究し、IVRC 2017・2018 で決勝大会に進出、IVRC 2019 で総合優勝。
          2020 年にグリー株式会社へ新卒入社し、メタバースライブ配信アプリ「REALITY」のバックエンド開発を担当。新卒 MVP を受賞したほか、フロントエンドエンジニア、データエンジニア、エンジニアリングマネージャーなどを経験。
          2025 年からは株式会社メルカリでフィンテック領域の開発に携わり、暗号資産取引サービスの開発や、AI エージェントを活用した開発支援に取り組む。
        </p>
